...
<head>
    ...
    <meta name="author" content="Prasta Haitsam L. & Yozakha Kirnanta">
                            ...
                            <tbody>
                                <?php while ($data = mysqli_fetch_array($qrySS)) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php
                                                                if ($data['aktif'] == "Y") echo "Ya";
                                                                else echo "Tidak";
                                                                ?>
                                        </td>
                                        <td class="text-center">
                                            <button class="btn py-0" name="btnGuruU" value="<?= $data['ID']; ?>"><i class="fas fa-edit"></i> Ubah
                                            </button>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
